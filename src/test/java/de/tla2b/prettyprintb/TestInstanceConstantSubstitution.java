...
public class TestInstanceConstantSubstitution {
	...
	public void TestExp4Con() throws Exception {
		StringBuilder sb = Util.translate(path + "InstanceValue.tla");
	...
	public void TestCon4Con() throws Exception {
		StringBuilder sb = Util.translate(path + "InstanceValue2.tla");
	...
	public void TestDef4OpArg() throws Exception {
		StringBuilder sb = Util.translate(path + "InstanceOpArg2.tla");
	...
	public void TestOpArg4OpArgException() throws Exception {
		Util.translate(path + "InstanceOpArgException.tla");
	}

	@Test
	public void TestOpArg4OpArg() throws Exception {
		StringBuilder sb = Util.translate(path + "InstanceOpArg3.tla", "InstanceOpArg3.cfg");
	...
	public void TestInstanced2Times() throws Exception {
		StringBuilder sb = Util.translate(path + "InstanceInstanceOpArg.tla", "InstanceInstanceOpArg.cfg");
